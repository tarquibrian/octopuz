...
local colors = require("octopuz.colors")
...
function M.setup()
  ...
  theme.highlights = {
    ...
    Directory = { fg = "#4fd6be" }, -- directory names (and other special names in listings)
    ...
    Statement = { fg = "#4fd6be" }, -- (preferred) any statement
    ...
    --- Functions
    ["@constructor"] = { fg = "#cbf3f0" }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
