local ts = require("octopuz.treesitter")
...
function M.invert_color(color)
  local hsluv = require("octopuz.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  local group = vim.api.nvim_create_augroup("octopuz", { clear = true })
